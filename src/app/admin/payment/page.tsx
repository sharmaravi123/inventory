...
export default function PaymentsDashboardPage() {
  ...
  const handleMakePayment = async () => {
    ...
    try {
      ...
      setSuccessMsg(
        `${formatCurrency(totalPaymentAmount)} recorded for ${selectedCustomer.shopName || selectedCustomer.name
        }`
      );
      setShowSuccess(true);
            ...
            <div className="flex flex-wrap items-center gap-2">
              {[
                ...
                <button
                  ...
                  className={`inline-flex items-center gap-1.5 rounded-full px-3.5 py-1.5 text-xs font-semibold transition ${dateFilterType === type
                ...
                {customersAggregated.map((c) => (
                  ...
                  >
                    ...
                    <td className="px-2 py-3 text-right">
                      <span
                        className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold ${c.totalDue > 0
                      ...
                      {paymentPreview.map((p) => (
                        ...
                        >
                          ...
                          <td className="py-1.5 pl-2 pr-3 text-center">
                            <span
                              className={`inline-flex rounded-full px-2.5 py-0.5 text-[9px] font-semibold ${p.remainingDue === 0
